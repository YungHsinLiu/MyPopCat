  ...
  function changeSrc()
  {
      ...
      document.getElementById("myPopCat").src="images/seal_2.jpg" ;
      timeoutId = setTimeout(function() {
          document.getElementById("myPopCat").src="images/seal_1.jpg" ;
      }, 200); 
...
function sendPost()
{
    ...
    fetch( "https://d656-60-250-125-146.ngrok.io/pop", {
        method: 'post',
        headers: {
...
{
    await fetch("https://d656-60-250-125-146.ngrok.io/show")
    .then(
